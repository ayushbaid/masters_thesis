...
\begin{figure}[!h]
    \twoAcrossLabelsLargest {/phantom/image_rrmse_noise} {/phantom/image_rrmse_smokelevels} {(a)}{(b)}
    \twoAcrossLabelsLargest {/phantom/ssim_noise} {/phantom/ssim_smokelevels} {(c)}{(d)}
    \caption{
