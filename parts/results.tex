...
An example of processing on synthetically corrupted phantom is \Figref{fig:imagesPhantom1}. Gibson ICIP13 \cite{gibson2013wiener} plus inpaiting does a poor job at removing smoke. Bilateral filtering, He PAMI11 \cite{he2011dark} plus inpainting does a decent smoke at desmoking, but the inpainting performance is poor. Our dictionary prior does a better job of filling in texture. Proposed method VBEM has the best removal of smoke, better texture and colors.
...
\begin{figure}[!h]
    \twoAcrossLabels {Pics/pgt/shortlist/exp21/1-exp21-x1_ground_truth} {Pics/pgt/shortlist/exp21/1-exp21-x2_corrupt} {1.8} {(a)} {(b)}
    \twoAcrossLabels {Pics/pgt/shortlist/exp21/1-exp21-x7_vb} {Pics/pgt/shortlist/exp21/1-exp21-x3_seq}  {1.8} {(c)} {(d)}
    \oneWidthLabel {Pics/pgt/shortlist/exp21/1-exp21-x5_wiener.png} {1.8} {(e)}
    \caption
    {
        %
        {\bf Validation on Laparoscopy Data. }
